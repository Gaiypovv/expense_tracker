...
class _MyChartState extends State<MyChart> {
    ...
    return BarChartData(
        titlesData: FlTitlesData(
          ...
          bottomTitles: AxisTitles(
            ...
            showTitles: true,
            reservedSize: 38,
            getTitlesWidget: getTitels,
          )),
          leftTitles: AxisTitles(
            sideTitles: SideTitles(
              showTitles: true,
              reservedSize: 38,
              getTitlesWidget: leftTitels,
            ),
          ),
        ),
  ...
  Widget getTitels(double value, TitleMeta meta) {
    const style =
        TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 1);
  ...
  Widget leftTitels(double value, TitleMeta meta) {
